...
static constexpr auto qt_meta_stringdata_ZN13MessageBubbleE = QtMocHelpers::stringData(
    "MessageBubble"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13MessageBubbleE[] = {
...
Q_CONSTINIT const QMetaObject MessageBubble::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13MessageBubbleE.offsetsAndSizes,
    qt_meta_data_ZN13MessageBubbleE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13MessageBubbleE_t,
        // Q_OBJECT / Q_GADGET
...
void *MessageBubble::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13MessageBubbleE.stringdata0))
